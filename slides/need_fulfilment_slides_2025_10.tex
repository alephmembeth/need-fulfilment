...
\setbeamertemplate{footline}{
   ...
   \vspace*{.042\paperheight}
      \fontsize{4.4}{5.9}\selectfont\color{black}\textbf{Distributive Justice and Reference Points Revisited}\newline\color{gray}\insertauthor~--~School of Humanities and Social Sciences, Department of Philosophy
   \vspace*{.026\paperheight}
   \end{beamercolorbox}
   }
   \vskip0pt
...
\begin{frame}{\vspace*{10mm}1\hspace*{1em}Prehistory}
   ...
   \medskip
   \begin{center}
      \frame{\includegraphics[width=0.25\linewidth]{figures/figure_bauer_2025.pdf}}\\
